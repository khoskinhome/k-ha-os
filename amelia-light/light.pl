...
my $i = 0;
$light_max_num = $i;
$stylight[$i] = ''; #get_style( $statty_stuff->{${thelight}_lights_config}{"${thelight}_light_$i"}{current_state});
$lightimg[$i] = get_light_img( $statty_stuff->{gpio_conf}{"${thelight}_light_$i"}{current_state} );
